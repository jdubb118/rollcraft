...
export const POSITIONS: Record<Position, PositionData> = {
  'standing': {
    ...
    topCategories: ['takedown', 'transition', 'setup'],
    bottomCategories: ['takedown', 'transition', 'setup'],
  },
  'clinch': {
    id: 'clinch', name: 'Clinch', symmetric: true,
    advantage: 'neutral', atbModTop: 1.0, atbModBottom: 1.0,
    damageModTop: 1.0, damageModBottom: 1.0,
    topCategories: ['takedown', 'submission', 'transition', 'setup'],
    bottomCategories: ['takedown', 'submission', 'transition', 'setup'],
  },
  'closed-guard': {
    ...
    topCategories: ['pass', 'transition', 'setup'],
    bottomCategories: ['sweep', 'submission', 'transition', 'setup'],
  },
  'open-guard': {
